...
public void CheckValidationTOWin(int Marker) {
  ...
  //Check horizontal boxes in board
   ...
   if((GArray[0] == Marker && GArray[1] == Marker && GArray[2] == Marker) || (GArray[3] == Marker && GArray[4] == Marker && GArray[5] == Marker) || (GArray[6] == Marker && GArray[7]== Marker && GArray[8] == Marker))
    {
    	...
    	if ((GArray[0] == Marker && GArray[3] == Marker && GArray[6] == Marker) || (GArray[1] == Marker && GArray[4] == Marker && GArray[7] == Marker) || (GArray[2] == Marker && GArray[5] == Marker && GArray[8] == Marker))	
    {
    	...
    	if ((GArray[0] == Marker && GArray[4] == Marker && GArray[8] == Marker) || (GArray[6] == Marker && GArray[4] == Marker && GArray[2] == Marker)) 
